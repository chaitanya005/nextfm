...
import Episode_34 from "../../components/Episodes/Ep34";
import Sidebar_34 from "../../components/Episodes/Sidebar_34";

const Episode34 = () => {
  return (
    <>
      <Head>
        <title>Heath Slawner: On How To Find Your WHY?</title>
          ...
          <div className="row h-100 align-items-center">
            <div className="col-12">
              <div className="breadcrumb-content">
                <h2 className="page-title">Episode #34</h2>
