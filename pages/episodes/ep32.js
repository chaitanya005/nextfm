...
import Episode_32 from "../../components/Episodes/Ep32";
import Sidebar_32 from "../../components/Episodes/Sidebar_32";
          ...
          <div className="row h-100 align-items-center">
            <div className="col-12">
              <div className="breadcrumb-content">
                <h2 className="page-title">Episode #32</h2>
