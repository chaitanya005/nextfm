              ...
              <div className="card" data-wow-delay="300ms">
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    ...
                    <div className="post-meta">
                      <a className="post-date">
                        <i className="zmdi zmdi-alarm-check"></i> Aug 31, 2020
                      </a>
                      <a
                        className="post-author"
              ...
              <div className="card" data-wow-delay="300ms">
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    ...
                    <div className="post-meta">
                      <a className="post-date">
                        <i className="zmdi zmdi-alarm-check"></i> Aug 17, 2020
                      </a>
                      <a
                        className="post-author"
                        ...
                        target="_blank"
                      >
                        <i className="zmdi zmdi-account"></i> Michael Kennedy
                      </a>
                    </div>
                    <p>
              ...
              <div className="card" data-wow-delay="300ms">
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    ...
                    <div className="post-meta">
                      <a className="post-date">
                        <i className="zmdi zmdi-alarm-check"></i> August 3, 2020
                      </a>
                      <a
                        className="post-author"
                        ...
                        target="_blank"
                      >
                        <i className="zmdi zmdi-account"></i> Josh Starmer
                      </a>
                    </div>
                    <p>
              ...
              <div className="card" data-wow-delay="300ms">
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    ...
                    <div className="post-meta">
                      <a className="post-date">
                        <i className="zmdi zmdi-alarm-check"></i> July 20, 2020
                      </a>
                      <a
                        className="post-author"
                        ...
                        target="_blank"
                      >
                        <i className="zmdi zmdi-account"></i> Frank Kane
                      </a>
                    </div>
                ...
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    ...
                    <p className="card-text text-center">
                      ...
                      time? On this episode, Sai shared his personal journey
                      from a student at ITM to one of the directors. Revealing
                      his purpose behind community based learning and its
                      potential outcomes with multiple viewpoints. Sai answered
                      the questions that could help any learner, any leader who
                      is trying to create an impact on their own approaches. On
                      top of sharing his experience as the Founder and Director
                      of LetsUpgrade,{" "}
                    </p>
                  </div>
                </div>
            ...
            <div className="single-blog-area wow fadeInUp">
              <div className="card" data-wow-delay="300ms">
                <div className="card-body" data-wow-delay="300ms">
                  ...
                  <div className="single-blog-text text-center">
                    <a className="blog-title">
                      Sudharsan Ravichandiran: On Authoring Best-Selling Books
                      in Data Science
                    </a>
                    <div className="post-meta">
                      <a className="post-date">
                    ...
                    <p className="card-text text-center">
                      ...
                      professional exploits in his career as a Data Scientist
                      and a Bestselling Author. In this podcast, Sudharsan
                      exposed a little about his Book “Hands-on Deep Learning
                      algorithms with Python“ with various questions on
                      kickstarting a career in Data Science.{" "}
                    </p>
                  </div>
                </div>
                <div className="blog-btn">
