  ...
  state = {
    ...
    episodes: [
      ...
      },
      {
        ...
        ep_link: "/ep33",
        guest_linkedln: "https://www.linkedin.com/in/boris-paskhaver/",
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/24qXD6wChudXyK2YUGCVcO",
      },
      {
        id: 32,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5Fot4Nv3rrCYiRZGd5nWBQ",
      },
      {
        id: 31,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/1YwS7Owfm80j3f8EjcWCFD",
      },
      {
        id: 30,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5P05O272Qr8yxGCBMta3tz",
      },
      {
        id: 29,
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5QC2kp0pqrfLxuYRnSZOpY",
      },
      {
        id: 28,
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/3nwjLeDLRp491toKsZxZfm",
      },
      {
        id: 27,
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/01SBfatiCMsiZoAJAbRmB5",
      },
      {
        id: 26,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/1SkwC4bxS6cQz8qxeg7ibQ",
      },
      {
        id: 25,
        epTitle:
        ...
        ep_link: "/ep25",
        guest_linkedln:
          "https://www.linkedin.com/in/christian-clausen-276a792b/",
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/03812Nslt0iIFKz13uJRPa",
      },
      {
        id: 24,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/2r2rTaAinJ4lQT804jCsjs",
      },
      {
        id: 23,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5mXt7gkuvm6PPYAuDdCUyD",
      },
      {
        id: 22,
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5TQNxBHQWeTSQgS1gkPwOV",
      },
      {
        id: 21,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/1wN5i7iPRSz3UUOm2Rb5xX",
      },
      {
        id: 20,
        epTitle:
        ...
        ep_desc:
          "Are you an engineering fresher? Or a sophomore. Figuring out an optimal approach to learning various technologies and balancing programming skills is challenging for most. In this conversation, Prateek and Teja spoke about How to build an effective path for all the college mates.",
        ep_link: "/ep20",
        guest_linkedln: "https://www.linkedin.com/in/prateek-narang-0108b39a/",
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/27Tuf6PEsiQ94KgGVLBFoT",
      },
      {
        id: 19,
        epTitle:
        ...
        ep_desc:
          "No matter where you’re at with technologies, you may want to start or shift or build a career in data science, with Mat Leanord, Senior AI Engineer and the one who launched the school of AI at Udacity shared his life journey from Physics to Neuro Science and to Data Science.",
        ep_link: "/ep19",
        guest_linkedln: "https://www.linkedin.com/in/matcleonard/",
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/72oCAAJBw7NuxruHCIHUs9",
      },
      {
        id: 1,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/3y1dFVjwTUJHdg5LyXk1vt",
      },
      {
        id: 2,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/504XRCzLkqFFovqnX876ji",
      },
      {
        id: 3,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/1fl5oVIU7mBd7J7T2FEl5G",
      },
      {
        id: 4,
        epTitle:
      ...
      },
      {
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5e13nDd91PTOycmR1LCACd",
      },
      {
        id: 6,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/0A0n4MmmR7ybo30Pl5ZmLU",
      },
      {
        id: 7,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/0HGH27BNoMu0X0lWewgANt",
      },
      {
        id: 8,
        epTitle:
...

      {
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/2CITL9oJJYtJVSIDR22VNr",
      },

      {
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5RbgqW4hHQTqClSP8xzrOr",
      },

      {
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/5tcTFKP4R3ZJbi9vDZ4htG",
      },
      {
        id: 12,
        epTitle:
        ...
        spotify_link:
          "https://open.spotify.com/embed-podcast/episode/4bsiOTn5VFHW3o6gpG7x7t",
      },
    ],
  };
              ...
              <div>
                {episodes.slice(0, this.state.visible).map((item, i) => (
                  <React.Fragment key={item.id}>
                    ...
                    {i == episodes.slice(0, this.state.visible).length - 1 &&
                    this.state.visible < episodes.length ? (
                      <div className="blog-btn">
                        <button
                          className="btn confer-btn"
                          onClick={this.loadMoreEpisodes}
                        >
                          {" "}
